...
export default function Create() {
  ...
  const [imageBase64, setImageBase64] = useState(null); // is a way to turn the image into a text so they can be sent to the internet or server
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // get file extension from the image uri or default to jpeg
      ...
      const response = await fetch(`${API_URL}/books`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`, // Must have a token to access this route
        ...
        body: JSON.stringify({
          ...
          image: imageDataUrl, // send the base64 image
        }),
      })
